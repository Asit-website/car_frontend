                                                ...
                                                <div className="wrap-hover-listing">
                                                    <div className="listing-item active" title="Lexus LC Hybrid 2024">
                                                        <div className="images">
                                                            <img src={val?.Photos[0] ? val?.Photos[0] : null} className="swiper-image tfcl-light-gallery" alt="images" />
                                                        </div>
                                                    </div>
                                                    <div className="listing-item" title="Lexus LC Hybrid 2024">
                                                        <div className="images">
                                                            <img src={val?.Photos[1] ? val?.Photos[1] : null} className="swiper-image tfcl-light-gallery" alt="images" />
                                                        </div>
                                                    </div>
                                                    <div className="listing-item view-gallery" title="Lexus LC Hybrid 2024">
                                                        <div className="images">
                                                            <img src={val?.Photos[2] ? val?.Photos[2] : null} className="swiper-image tfcl-light-gallery" alt="images" />

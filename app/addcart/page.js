          ...
          <div className="tf-video-car-banner">
            <div className="themesflat-container full">
              <div className="widget-video-car ">
                <Link
                  href="/https://www.youtube.com/watch?v=6u_j4d9D4Rc"
            ...
            <div className="themesflat-container">
              <div className="tf-add-cart">
                <form
                  ...
                  id="submit-add-cart"
                  className="form-add-cart needs-validation"
                  noValidate
                >
                      ...
                      <div className="form-group">
                        ...
                        <div className="group-select">
                          ...
                          >
                            ...
                            <option data-value="Ferrari" className="option">
                              Ferrari
                            </option>
                            <option data-value="Ford" className="option">
                              Ford
                            </option>
                            <option data-value="Lexus" className="option">
                              Lexus
                            </option>
                            <option data-value="Maybach" className="option">
                              Maybach
                            </option>
                            <option data-value="Mercedes" className="option">
                              Mercedes
                            </option>
                            <option data-value="Porsche" className="option">
                              Porsche
                            </option>
                            <option data-value="Toyota" className="option">
                              Toyota
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        ...
                        <div className="group-select">
                          ...
                          >
                            ...
                            <option data-value="SUV" className="option">
                              SUV
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        ...
                        <div className="group-select">
                          ...
                          >
                            ...
                            <option data-value="3WD" className="option">
                              3WD
                            </option>
                            <option data-value="4WD" className="option">
                              4WD
                            </option>
                            <option data-value="WD" className="option">
                              WD
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        ...
                        <div className="group-select">
                          ...
                          >
                            ...
                            <option data-value="Green" className="option">
                              Green
                            </option>
                    ...
                    <div className="listing-fields-grid mb-30">
                      <div className="form-group">
                        ...
                        <div className="group-select">
                          <div className="radio">
                            <input
                              name="RequestPriceLabel"
                              onChange={changeHandler}
                              value={carDetail?.RequestPriceLabel}
                              id="first"
                              type="radio"
                              defaultValue="first"
                            />
                  ...
                  <fieldset id="location" className="pd-bg mb-60">
                    ...
                    <p className="location mb-20">
                      *Note: Just type the address into the search bar in the
                      upper-right corner of the map below, then press the Enter
                      key.
                    </p>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <div className="group-map-address-field">
                        <input
                          className="address-searching "
                          id="address-searching"
                          type="text"
                          aria-invalid="false"
                        />
                  ...
                  <fieldset id="upload-media" className="pd-bg">
                    ...
                    <p className="one-photo text-red">
                    ...
                    <div className="form-group">
                      <div className="group-video">
                        <input
                          type="url"
                          id="link-video"
                          placeholder="Www.youtube.com/mehedii mohammad"
                          required
                        />
                      </div>
                    </div>
